...
<div class="utility-stack">
    ...
    <!-- Electric -->
    <section class="utility-block utility-block--electric">
        <div class="utility-block-header">
    ...
    <div class="utility-separator" aria-hidden="true"></div>

    <!-- Generator -->
    <section class="utility-block utility-block--generator">
        <div class="utility-block-header">
    ...
    <!-- Water -->
    <section class="utility-block utility-block--water">
        <div class="utility-block-header">
    ...
    <!-- Propane -->
    <section class="utility-block utility-block--propane">
        <div class="utility-block-header">
