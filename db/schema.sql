-- schema.sql — Complete house info database schema (as of final version)

-- Create database (optional — run if starting fresh)
-- CREATE DATABASE house_info CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE house_info;

-- Houses table (main entities)
CREATE TABLE IF NOT EXISTS houses (
    ...
    map_zoom TINYINT DEFAULT 16,
    google_embed_src VARCHAR(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Permanent items (furnace, water heater, etc.)
...
CREATE TABLE IF NOT EXISTS solar_strings (
    id INT AUTO_INCREMENT PRIMARY KEY,
    house_id INT NOT NULL,
    connection_type ENUM('Series', 'Parallel') NOT NULL,
    FOREIGN KEY (house_id) REFERENCES houses(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS breakers (
    ...
    column_num TINYINT NOT NULL,        -- 1 or 2 (left/right column)
    row_num TINYINT NOT NULL,           -- 1 to 28
    room VARCHAR(100) DEFAULT NULL,     -- Location / room name
    amp INT DEFAULT 0,                  -- Amperage rating
    FOREIGN KEY (panel_id) REFERENCES electric_panels(id) ON DELETE CASCADE,
    UNIQUE KEY unique_breaker (panel_id, column_num, row_num)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Home lab LXC containers and VMs
...
CREATE TABLE IF NOT EXISTS photos (
    id INT AUTO_INCREMENT PRIMARY KEY,
    house_id INT NOT NULL,
    section ENUM('Interior', 'Exterior', 'Walkthrough') DEFAULT NULL,
    filename VARCHAR(255) NOT NULL,
    is_ir TINYINT(1) NOT NULL DEFAULT 0,  -- 0 = regular, 1 = IR scan
    upload_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (house_id) REFERENCES houses(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS designs (
    ...
    house_id INT NOT NULL,
    filename VARCHAR(255) NOT NULL,
    thumbnail VARCHAR(255) DEFAULT NULL,   -- Path to generated PDF thumbnail (e.g. thumbs/thumb_xxx.png)
    upload_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (house_id) REFERENCES houses(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS permanent_maintenance_log (
    ...
    contractor_price DECIMAL(10,2) DEFAULT NULL,
    payment_method ENUM('debit', 'cc', 'check', 'cash') DEFAULT NULL,
...
INSERT IGNORE INTO houses (id, name) VALUES (1, 'Main House'), (2, 'Guest House');
